...
class GetMoviesServiceTest: XCTestCase {
    ...
    override func tearDown() {
        ...
        getMoviesService = nil
    }
    
    func testGetMoviesServiceSuccess() {
        let json = """
        {
            "results": [
                {
        ...
        getMoviesService = GetMoviesService(dispatcher: mockedDispatcher!)
        
        self.getMoviesService?.execute(completionHandler: { (movies) in
